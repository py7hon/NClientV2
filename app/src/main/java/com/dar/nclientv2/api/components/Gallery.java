...
public class Gallery extends GenericGallery{
    ...
    public String getCover(){
        return String.format(Locale.US,"https://kontol.nhent.ai/galleries/%d/cover.%s",mediaId,extToString(cover));
    }
    public String getThumbnail(){
        return String.format(Locale.US,"https://kontol.nhent.ai/galleries/%d/thumb.%s",mediaId,extToString(thumbnail));
    }

    public String getPage(int page){
        return String.format(Locale.US,"https://i.bakaa.me/galleries/%d/%d.%s",mediaId,page+1,extToString(pages[page]));
    }
    public String getLowPage(int page){
        return String.format(Locale.US,"https://kontol.nhent.ai/galleries/%d/%dt.%s",mediaId,page+1,extToString(pages[page]));
    }
